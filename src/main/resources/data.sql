INSERT INTO USER_DETAILS (ID, CREATED, FULL_NAME, NICK, EXPIRED)
VALUES (1, '2022-10-10', 'Joe Doe', 'joedoe', null);
INSERT INTO USER_DETAILS (ID, CREATED, FULL_NAME, NICK, EXPIRED)
VALUES (2, '2022-10-10', 'Max Musserman', 'maxmusserman', null);
...
VALUES (1, '2022-10-10',
        ...
        'Monitoring Project', 'MONPR', 'NEW', 'Project about monitoring', 1, 2, null);
...
VALUES (2, '2022-10-11',
        ...
        'Building Project', 'BUIPR', 'NEW', 'Project about building', 1, 2, null);

INSERT INTO PROJECT (ID, CREATED, DESCRIPTION, NAME, SHORT_FORM, STATUS, SUMMARY, CREATED_BY_ID, OWNER_ID,
                     EXPIRED)
VALUES (3, '2022-10-12',
        'Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur?',
        'Watching Project', 'WATPR', 'IN_PROGRESS', 'Project about watching', 2, 1, null);
...
INSERT INTO USER_PROJECT (ID, PROJECT_ID, USER_ID, ROLE, CREATED, EXPIRED)
VALUES (1, 1, 1, 'DEVELOPER', '2022-10-12', null);

INSERT INTO USER_PROJECT (ID, PROJECT_ID, USER_ID, ROLE, CREATED, EXPIRED)
VALUES (2, 1, 2, 'DEVELOPER', '2022-10-12', null);

INSERT INTO USER_PROJECT (ID, PROJECT_ID, USER_ID, ROLE, CREATED, EXPIRED)
VALUES (3, 2, 1, 'DEVELOPER', '2022-10-12', null);

INSERT INTO USER_PROJECT (ID, PROJECT_ID, USER_ID, ROLE, CREATED, EXPIRED)
VALUES (4, 2, 2, 'DEVELOPER', '2022-10-12', null);

INSERT INTO USER_PROJECT (ID, PROJECT_ID, USER_ID, ROLE, CREATED, EXPIRED)
VALUES (5, 3, 1, 'TESTER', '2022-10-12', null);

INSERT INTO USER_PROJECT (ID, PROJECT_ID, USER_ID, ROLE, CREATED, EXPIRED)
VALUES (6, 3, 2, 'MANAGER', '2022-10-12', null);


INSERT INTO TASK (ID, CREATED, DESCRIPTION,
                  DUE_DATE, ESTIMATION, NUMBER,
                  PRIORITY, STATUS, SUMMARY, TYPE, ASSIGNEE_ID,
                  CREATED_BY_ID, OWNER_ID, PROJECT_ID, EXPIRED)
VALUES (1, '2022-10-10',
